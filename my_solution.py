...
def solution(my_list, key):
    #test the solution
    temp = list(rearange(my_list, key))
    #convert list of tuples into list of lists
    for i in temp:
        temp2.append(list(i))

    #print(temp2)
    #use the prettytable library to out put new list in table style format
    table = PrettyTable()
    #set attributes
    table.border = True
    table.header = False
...
solution([4,35,80,23,12345,44,8,5,24,3], 4)